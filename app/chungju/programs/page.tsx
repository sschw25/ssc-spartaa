...
export const metadata = getCampusSubpageMetadata('chungju', 'programs')

export default function ChungjuProgramsPage() {
  return (
    <main className="overflow-x-hidden pb-16 md:pb-0">
      ...
      {/* 📁 사진 위치: public/images/programs/chungju/ */}
      <MonthlyProgram campus="chungju" title="이달의 프로그램" showEmpty />
