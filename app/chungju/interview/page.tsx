...
export const metadata = getInterviewMetadata('chungju')

// FAQ 데이터
const FAQ_LIST = [
  {
    question: '필기합격 발표 전에도 신청(사전등록)할 수 있나요?',
    answer: '네, 사전등록이 극도로 권장됩니다! 특히 충북 교육행정직의 경우 7월 21일 필기합격 발표 바로 다음 날인 7월 22일에 1차시 정규 수업이 시작됩니다. 발표 이후에 등록하시려면 자소서 초안 작성 및 과제 처리에 시간이 매우 부족할 수 있습니다. 합격 확실권 또는 가능성이 있으신 분들은 발표 전에 사전등록 신청서를 꼭 제출해주시기 바랍니다. (※ 발표 후 불합격 시 전액 환불됩니다.)',
  },
  {
    question: '외부 수강생도 등록할 수 있나요?',
    answer: '네, 가능합니다. SSC스파르타 기존 원생이 아니더라도 충북 공무원 면접을 준비하는 수험생이라면 누구나 등록하여 동일한 혜택(사물함 선착순 제공 등)을 누리실 수 있습니다. 다만 면접반 단기 수강생에게는 별도의 자습 공간(독서실 좌석)은 제공되지 않는 점 양해 부탁드립니다.',
  },
  {
    question: '1:1 개인코칭은 어떻게 진행되나요?',
    answer: '1:1 추가반을 신청하시면 SSC스파르타의 1:1 개별 밀착 코칭이 50분간 제공됩니다. 작성하신 자기소개서와 지원동기 첨삭뿐만 아니라 실제 말할 때의 속도, 시선 처리, 태도, 나쁜 습관 교정까지 개인별 맞춤 피드백을 전달해 드립니다. (※ 지난 국가직 및 경채 면접반의 경우 수강생의 90%가 1:1 개인코칭 포함반을 신청해 면접을 대비했습니다.)',
  },
  {
  ...
  },
  {
    ...
    answer: '네, 물론입니다. 매년 기계, 토목, 건축 등 특수 및 기술직렬 최종 합격자를 다수 배출해 온 데이터가 구축되어 있어 신뢰할 수 있습니다. 면접 공통 주제 외에도 특수직렬 맞춤형 기출 질문 및 답변 팁이 정리된 전문 자료를 제공합니다. 전공 및 직렬 특화 질문이 핵심인 만큼, 1:1 개인코칭 밀착반을 수강하시면 합격 확률을 극대화하실 수 있습니다.',
  },
]
...
const INTERVIEW_TESTIMONIALS = [
  {
    ...
    quote: '필기 합격 발표 후에 면접 준비 기간이 생각보다 너무 짧아서 눈앞이 캄캄했습니다. 하지만 SSC스파르타 면접반에서 제공해 준 기출 핵심 분석집과 답변 구조화 공식 덕분에 어떤 예상외 질문이 들어와도 당황하지 않고 차분히 답변 뼈대를 구성해 낼 수 있었습니다. 1:1 개인코칭 때 원장님께서 제 시선 처리나 말끝을 흐리는 세세한 습관까지 날카롭게 짚어 교정해 주신 덕분에 실전 면접장에서 최고의 태도로 임할 수 있었습니다.',
  },
  {
    name: '이O정 수험생',
    result: '지방직 토목직 최종 합격',
    quote: '전공 과목 면접에 대한 부담이 정말 컸는데, SSC스파르타에 축적되어 있던 기계·토목·건축 등 기술직렬 합격자 데이터와 전공 질문 요약집이 구세주였습니다. 면접 공통 주제를 넘어 제 전공 지식을 자연스럽게 공직 가치와 엮어 표현하는 1:1 밀착 코칭이 결정적이었습니다. 꼬리 질문이 쏟아졌을 때도 코칭 때 배운 방어 요령을 적용해 무사히 면접을 마칠 수 있었습니다.',
  },
  {
    name: '박O현 수험생',
    result: '충북 교육행정직 최종 합격',
    quote: '교육행정 면접은 지자체 도정 현안뿐만 아니라 교육청 고유의 핵심 정책을 꿰뚫고 있어야 해서 막막했습니다. 학원에서 챙겨준 충북 교육정책 핵심 요약집 덕분에 정책 방향을 완벽히 이해할 수 있었습니다. 특히 매주 금요일 스터디원들과 실전처럼 조를 짜서 모의면접을 하고 상호 피드백 시트를 교환하며 반복 연습했던 것이 말문이 트이는 데 엄청난 도움이 되었습니다.',
  }
]
  ...
  return (
    <main className="overflow-x-hidden bg-[#F8F9FA] text-[#1D1D1F] min-h-screen pb-24 md:pb-0">
      ...
      <section className="bg-white py-16 md:py-24 border-b border-[#E5E7EB]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-lg text-[#86868B] max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            SSC스파르타의 체계적인 면접 대비 시스템으로 충주캠퍼스에서 본수업과 1:1 피드백을 밀착 진행합니다.
          </p>
      ...
      <section className="py-16 max-w-5xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm">
            ...
            <h3 className="text-lg font-bold mb-2">체계적인 금요 자율스터디</h3>
            <p className="text-[#86868B] text-sm leading-relaxed">
              매주 금요일 오전 충주캠퍼스에서 진행되는 실전 자율스터디. 3~5명씩 조를 편성하고 면접관과 수험생 역할을 상호 교대하며 말문이 트이도록 무한 훈련합니다.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm">
      ...
      <section className="py-12 bg-white border-y border-[#E5E7EB]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-3">수강 과정 & 등록 수강료</h2>
            ...
            <div className="border border-[#E5E7EB] rounded-2xl p-8 relative flex flex-col justify-between bg-[#F8F9FA]">
              <div>
                ...
                <ul className="space-y-3.5 text-sm text-[#515154] mb-8">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-[#0071E3] shrink-0 mt-0.5" />
                    <span>충주/충청북도 지자체 지역 현안 핵심 요약집</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-[#0071E3] shrink-0 mt-0.5" />
                    <span>충주캠퍼스 사물함 제공 (잔여 수량 있을 시 선착순)</span>
                  </li>
                </ul>
              </div>
              <a
      ...
      <section className="py-16 max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-xl border border-[#E5E7EB] flex gap-4">
            ...
            <div>
              <h4 className="font-bold text-[#1D1D1F] mb-1">자기소개서 및 지원동기 작성법</h4>
          ...
          <div className="bg-white p-6 rounded-xl border border-[#E5E7EB] flex gap-4">
            ...
            <div>
              <h4 className="font-bold text-[#1D1D1F] mb-1">공직가치관 및 상황제시형 질문 대응</h4>
              <p className="text-[#86868B] text-sm leading-relaxed mb-2">
          ...
          <div className="bg-white p-6 rounded-xl border border-[#E5E7EB] flex gap-4">
            ...
            <div>
              <h4 className="font-bold text-[#1D1D1F] mb-1">지자체 지역현안 및 직렬별 기출 분석 (강원·충북·경기 특화)</h4>
              <p className="text-[#86868B] text-sm leading-relaxed mb-2">
          ...
          <div className="bg-white p-6 rounded-xl border border-[#E5E7EB] flex gap-4">
            ...
            <div>
              <h4 className="font-bold text-[#1D1D1F] mb-1">실전 밀착 모의면접 및 모니터링</h4>
              <p className="text-[#86868B] text-sm leading-relaxed mb-2">
          ...
          <div className="bg-[#F5F5F7] p-6 rounded-xl border border-[#E5E7EB] flex gap-4">
            <div className="w-10 h-10 rounded-lg bg-emerald-50 text-[#34C759] font-bold text-sm flex items-center justify-center shrink-0">
              스터디
            </div>
            <div>
              <h4 className="font-bold text-[#1D1D1F] mb-1">금요 면접 자율스터디 (오전 09:30~12:30)</h4>
              <p className="text-[#86868B] text-sm leading-relaxed">
      ...
      <section className="py-16 bg-white border-y border-[#E5E7EB]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-3">충주캠퍼스 면접반 전체 일정</h2>
          ...
          <div className="overflow-x-auto rounded-xl border border-[#E5E7EB]">
            <table className="w-full text-left border-collapse min-w-[600px]">
              ...
              <tbody className="divide-y divide-[#E5E7EB] text-sm text-[#1D1D1F]">
                <tr>
                  <td className="py-4 px-6 font-semibold">7/16(목)</td>
                  <td className="py-4 px-6">충북 일반 지방직 공채 필기 발표</td>
                  <td className="py-4 px-6">-</td>
                  <td className="py-4 px-6 text-[#0071E3] font-semibold">필기 합격 확인 즉시 면접반 신청 및 플랫폼 가입</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-semibold">7/21(화)</td>
                  <td className="py-4 px-6">충북교육청 교육행정 필기 발표</td>
                  <td className="py-4 px-6">-</td>
                  <td className="py-4 px-6 text-[#F56300] font-semibold">★ 발표 즉시 면접반 등록 확인 및 안내</td>
                </tr>
                <tr className="bg-blue-50/20">
                  <td className="py-4 px-6 font-semibold text-[#0071E3]">7/22(수)</td>
                  <td className="py-4 px-6 font-semibold">충주 통합반 1차시 본수업</td>
                  <td className="py-4 px-6 text-[#0071E3] font-semibold">오후 14:00~17:00</td>
                  <td className="py-4 px-6">
                    <span className="block text-xs font-semibold text-[#F56300]">★ 교행 발표 다음날 바로 개강! 사전등록 필수</span>
                    자기소개서 작성 및 1분 스피치 뼈대 빌드업 (실강)
                  </td>
                </tr>
                <tr className="bg-blue-50/20">
                  <td className="py-4 px-6 font-semibold text-[#0071E3]">7/24(금)</td>
                  <td className="py-4 px-6">충주 자율스터디 / 2차시 본수업</td>
                  <td className="py-4 px-6">
                    오전 09:30~12:30 (스터디)<br />
                    오후 14:00~17:00 (2차시 수업)
                  </td>
                  <td className="py-4 px-6">오전에는 수강생 자율스터디, 오후에는 공직가치/상황질문 본수업 진행</td>
                </tr>
                <tr className="bg-blue-50/20">
                  <td className="py-4 px-6 font-semibold text-[#0071E3]">7/27(월)</td>
                  <td className="py-4 px-6 font-semibold">충주 통합반 3차시 본수업</td>
                  <td className="py-4 px-6 text-[#0071E3] font-semibold">오후 14:00~17:00</td>
                  <td className="py-4 px-6">충북도정 및 각 지자체 현안 분석, 직렬 전문 예상질문 학습</td>
                </tr>
                <tr className="bg-blue-50/20">
                  <td className="py-4 px-6 font-semibold text-[#0071E3]">7/30(목)</td>
                  <td className="py-4 px-6 font-semibold">충주 통합반 4차시 본수업</td>
                  <td className="py-4 px-6 text-[#0071E3] font-semibold">오후 14:30~17:30</td>
                  <td className="py-4 px-6">실전 대면 모의면접 피드백 및 답변 최종 정교화</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-semibold">7/31(금)</td>
                  <td className="py-4 px-6 font-semibold text-emerald-600">충주 1:1 개인 코칭 진행</td>
                  <td className="py-4 px-6 text-emerald-600">개별 예약 타임</td>
                  <td className="py-4 px-6">1:1 추가반 신청자 개별 밀착 대면 코칭 (원장단 직접 첨삭)</td>
                </tr>
                <tr>
                  <td className="py-4 px-6 font-semibold">7/31(금)</td>
                  <td className="py-4 px-6">충주 최종 자율스터디</td>
          ...
          <div className="mt-6 p-5 rounded-2xl bg-amber-50/60 border border-amber-100 flex items-start gap-3">
            ...
            <div className="text-xs md:text-sm text-[#F56300] leading-relaxed">
              <span className="font-bold">충북 교육행정직 수강생 필수 안내사항:</span><br />
              충북 교육행정직의 합격 발표일은 7월 21일(화)이며, 첫 수업(1차시)은 발표 바로 다음 날인 7월 22일(수) 오후 2시에 진행됩니다. 발표 직후 당일에 등록하여 사전과제(자소서 초안 등)를 준비하려면 물리적인 시간이 크게 부족합니다. 따라서 합격 가능성이 조금이라도 있으신 분들은 **발표 전에 미리 사전등록 신청서**를 제출하시어 사전 안내와 과제를 수령하시는 것을 강력히 권장해 드립니다.
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 합격생 후기 */}
      <Testimonials testimonials={INTERVIEW_TESTIMONIALS} campusName="충주" />

      {/* 자주 묻는 질문 FAQ */}
      <section className="py-16 max-w-3xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-3">자주 묻는 질문 (FAQ)</h2>
