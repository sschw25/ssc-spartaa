      ...
      <section className="bg-white py-16 md:py-24 border-b border-[#E5E7EB]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-[#1D1D1F] leading-tight mb-6">
            ...
            <span className="text-[#007AFF]">SSC스파르타 충주 면접반</span>
          </h1>
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              ...
              <tbody className="divide-y divide-[#E5E7EB] text-sm text-[#1D1D1F]">
                <tr>
                  ...
                  <td className="py-4 px-6 text-[#007AFF] font-semibold">필기 합격 확인 즉시 면접반 신청 및 플랫폼 가입</td>
                </tr>
                <tr>
                ...
                <tr className="bg-blue-50/20">
                  ...
                  <td className="py-4 px-6">
                    <span className="block text-xs font-semibold text-[#FF9500]">★ 교행 발표 다음날 바로 개강! 사전등록 필수</span>
                    자기소개서 작성 및 1분 스피치 뼈대 빌드업 (실강)
                  </td>
                </tr>
                <tr className="bg-blue-50/20">
                  <td className="py-4 px-6 font-semibold text-[#007AFF]">7/24(금)</td>
                ...
                <tr className="bg-blue-50/20">
                  ...
                  <td className="py-4 px-6 text-[#007AFF] font-semibold">오후 14:30~17:30</td>
