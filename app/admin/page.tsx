  ...
  if (checkingAuth) {
    return (
      <div className="min-h-screen bg-[#F5F5F7] flex flex-col items-center justify-center font-sans">
        ...
        <p className="text-[#86868B] text-sm">로그인 세션 확인 중...</p>
      </div>
    );
  }

  return (
    <main className="min-h-screen bg-gradient-to-br from-[#F5F5F7] via-white to-[#E5E7EB] flex flex-col items-center justify-center px-4 font-sans text-[#1D1D1F]">
      <div className="w-full max-w-md">
        
        {/* Logo or Title */}
        <div className="text-center mb-8">
          <span className="text-[10px] font-bold tracking-[0.4em] text-[#86868B] uppercase block mb-2">
        ...
        <Card className="border border-black/[0.05] shadow-xl rounded-2xl bg-white/80 backdrop-blur-md overflow-hidden">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-center text-[#86868B] text-xs">
          ...
          <form onSubmit={handleLogin}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="username" className="text-xs font-semibold text-[#1D1D1F]">
                  아이디
                </Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-xs font-semibold text-[#1D1D1F]">
                  비밀번호
                </Label>
                <div className="relative">
            ...
            <CardFooter className="pt-4 pb-6">
              <Button
                type="submit"
                disabled={loading}
                className="w-full py-5 rounded-xl font-bold bg-[#1D1D1F] hover:bg-[#323236] text-white transition-all text-xs"
              >
                {loading ? (
                  <>
