          ...
          <>
            <div className="grid grid-cols-3 gap-3">
              {([
                ...
                ['불참', 'bg-red-50 border-red-200/70 text-red-800', stats.absent],
                        ...
                        <tr key={s.id}>
                          ...
                          <td className="px-4 py-3">
                            <div className="flex flex-wrap gap-1.5 items-center">
                              ...
                              {selfResponded && <span className="rounded-lg bg-blue-50 text-blue-600 px-2 py-1 text-[10px] font-black">학생응답</span>}
                            </div>
