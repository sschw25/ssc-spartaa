...
const FAQ_LIST = [
  ...
  },
  {
    ...
    answer: '1:1 추가반을 신청하시면 SSC스파르타의 1:1 개별 밀착 코멘팅이 50분간 제공됩니다. 작성하신 자기소개서와 지원동기 첨삭뿐만 아니라 실제 말할 때의 속도, 시선 처리, 태도, 나쁜 습관 교정까지 개인별 맞춤 피드백을 전달해 드립니다. 자기소개서 첨삭은 필기발표 후 등록하면 바로 온라인으로 바로 진행됩니다. (※ 지난 국가직 및 경채 면접반의 경우 수강생의 90%가 1:1 개인코멘팅 포함반을 신청해 면접을 대비했습니다.)',
  },
  {
            ...
            <div className="border-2 border-[#007AFF] rounded-2xl p-8 relative flex flex-col justify-between bg-white shadow-lg shadow-blue-500/5">
              ...
              <div>
                ...
                <ul className="space-y-3.5 text-sm text-[#515154] mb-8">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-[#007AFF] shrink-0 mt-0.5" />
                    <span>자기소개서·지원동기 개별 서면 첨삭 (자기소개서 첨삭은 필기발표 후 등록하면 바로 온라인으로 바로 진행)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-[#007AFF] shrink-0 mt-0.5" />
                    <span>춘천캠퍼스 사물함 제공 (잔여 수량 있을 시 선착순)</span>
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              ...
              <tbody className="divide-y divide-[#E5E7EB] text-sm text-[#1D1D1F]">
                ...
                <tr className="bg-blue-50/20">
                  ...
                  <td className="py-4 px-6 text-[#007AFF] font-semibold">오후 14:00~17:00</td>
                  <td className="py-4 px-6">공채 및 교육행정 통합 수업 (춘천 교행 합류 가능)</td>
                </tr>
                <tr className="bg-blue-50/20">
                ...
                <tr className="bg-blue-50/20">
                  ...
                  <td className="py-4 px-6 text-[#007AFF] font-semibold">오후 14:00~17:00</td>
                  <td className="py-4 px-6">실전 대면 모의면접 피드백 및 답변 최종 정교화 (춘천 본수업 종료)</td>
                </tr>
              </tbody>
            </table>
          </div>
