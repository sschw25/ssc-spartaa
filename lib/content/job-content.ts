...
export const jobContent: StreamContent = {
  ...
  roadmap: {
    title: '취업 성공까지\n준비 로드맵',
    subtitle: '직무 설정부터 면접까지 단계별 흐름.\n목표 채용 일정에 맞춰 조정됩니다.',
    phases: [
      { period: '진단기', title: '직무·목표 기업 설정', focus: '직무를 정하고 현재 스펙·역량을 점검' },
      { period: '기본기', title: '자격증·어학·NCS', focus: '필요한 자격증과 어학·NCS 기초를 채우기' },
      { period: '서류', title: '자기소개서·이력서', focus: '직무 맞춤 자소서와 포트폴리오 완성' },
      { period: '인적성', title: '인적성·필기 대비', focus: '기업별 인적성·필기 전형 집중 대비' },
      { period: '면접', title: '직무·인성 면접', focus: '실전 모의면접으로 답변과 태도 완성', exam: true },
    ],
  },
  faqs: [
