...
const CAMPUS_SEO_CONFIG: Record<CampusKey, SeoContent> = {
  wonju: {
    title: 'SSC스파르타 원주캠퍼스 | 원주 독학재수 · 관리형독서실 · 공무원학원',
    description: '원주독학재수학원, 원주관리형독서실, 원주공무원학원을 찾는 수험생을 위한 시간 관리형 학습관 SSC스파르타 원주캠퍼스. 철저한 통제와 밀착 상담으로 합격을 돕습니다.',
    keywords: ['SSC스파르타 원주캠퍼스', '원주공무원학원', '원주독학재수학원', '원주관리형독서실', '원주 독학재수', '원주 관리형독서실', '원주 공무원학원', '원주 커넥츠프랩'],
  },
  chuncheon: {
    title: 'SSC스파르타 춘천캠퍼스 | 춘천 독학재수 · 관리형독서실 · 임용고시학원',
    description: '춘천독학재수학원, 춘천관리형독서실, 춘천임용고시를 준비하는 수험생을 위한 시간 관리형 학습관 SSC스파르타 춘천캠퍼스. 교시제 학습과 출결·스마트폰 밀착 통제.',
    keywords: ['SSC스파르타 춘천캠퍼스', '춘천임용고시', '춘천독학재수학원', '춘천관리형독서실', '춘천 독학재수', '춘천 관리형독서실', '춘천 임용학원'],
  },
  chungju: {
    title: 'SSC스파르타 충주캠퍼스 | 충주 독학재수 · 관리형독서실 · 공무원학원',
    description: '충주독학재수학원, 충주관리형독서실, 충주공무원학원을 준비하는 수험생을 위한 시간 관리형 학습관 SSC스파르타 충주캠퍼스. 교시제 학습과 완벽한 생활 리듬 관리.',
    keywords: ['SSC스파르타 충주캠퍼스', '충주공무원학원', '충주독학재수학원', '충주관리형독서실', '충주 독학재수', '충주 관리형독서실', '충주 공무원학원'],
  },
}
