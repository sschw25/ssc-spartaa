...
const STREAM_SEO_CONFIG: Record<StreamId, (region: string) => SeoContent> = {
  gongmuwon: (region: string) => ({
    ...
    description: `${region} 공무원학원 SSC스파르타. 2027 국가직·지방직 9급 개편(한국사능력검정 대체·과목당 25문항·직무형 국어/영어)에 맞춘 합격관리반. 노량진 커넥츠프랩 전국 평가와 2중 출결, 순공시간 집계, 면접 코칭까지 제공합니다.`,
  ...
  suneung: (region: string) => ({
    ...
    description: `${region} 독학재수학원 SSC스파르타. 통합수능 마지막 해인 2027학년도 수능(2026.11.19)까지 실전 교시제와 출결·순공시간·모의고사 분석으로 생활과 학습을 함께 관리하는 독학재수관입니다.`,
  ...
  imyong: (region: string) => ({
    ...
    description: `2027학년도 초등·중등·유아 임용(1차 2026.11) 준비를 위한 밀착 관리. 정숙한 학습 환경과 교시제 회독 관리, 2차 수업실연 지원까지 제공하는 ${region} 임용 특화 학습관 SSC스파르타.`,
  ...
  professional: (region: string) => ({
    ...
    description: `세무사·노무사·회계사 등 전문자격 준비를 위한 ${region} 관리형 학습관. 자격별 1·2차 일정을 플래너로 관리하고, 100분 교시제와 소음 허용 라운지로 성인 수험생의 몰입을 돕습니다.`,
  ...
  job: (region: string) => ({
    ...
    description: `공기업·대기업 취업을 준비하는 ${region} 취준생 베이스캠프. NCS·인적성 학습 공간과 자소서 타이핑 라운지, 면접 스터디룸까지 갖춘 관리형 학습관입니다.`,
  ...
  managed: (region: string) => ({
    ...
    description: `${region} 관리형독서실 SSC스파르타. 스마트폰 제출과 2중 출결, 100분 교시제, 학습 스케줄 밀착 관리로 면학 분위기와 순공시간을 지키는 프리미엄 독서실입니다.`,
...
export function getInterviewMetadata(campus: CampusKey): Metadata {
  ...
  if (campus === 'wonju') {
    ...
    description = '원주 공무원 면접학원 SSC스파르타. 원주, 강원, 삼척, 태백, 횡성 등 강원 및 인근 지역 지방직·교육행정직 필기합격자 대상 면접 전문 강사진 직강 4회와 1:1 코칭을 제공합니다.'
    keywords = [
      '원주 공무원 면접학원',
      '원주공무원면접학원',
      '원주 공무원 면접',
    ...
    description = '춘천 공무원 면접학원 SSC스파르타. 춘천, 강원, 홍천, 화천, 양구, 철원 등 강원 영서북부 지방직 및 교육행정직 필기합격자 대상 면접 전문 강사진 직강 4회와 1:1 코칭을 제공합니다.'
    keywords = [
      '춘천 공무원 면접학원',
      '춘천공무원면접학원',
      '춘천 공무원 면접',
    ...
    description = '충주 공무원 면접학원 SSC스파르타. 충주, 충북, 제천, 청주, 음성, 진천, 괴산 등 충북 전역 지방직 및 교육행정직 필기합격자 대상 면접 전문 강사진 직강 4회와 1:1 코칭을 제공합니다.'
    keywords = [
      '충주 공무원 면접학원',
      '충주공무원면접학원',
      '충주 공무원 면접',
