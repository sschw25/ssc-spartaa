    ...
    <main className="overflow-x-hidden pb-16 md:pb-0 font-sans">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-[#1D1D1F] overflow-hidden text-white">
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute top-[0%] left-[50%] -translate-x-1/2 w-[100%] h-[100%] bg-gradient-to-b from-[#007AFF]/20 via-[#007AFF]/5 to-transparent blur-[100px] rounded-[100%]" />
          <div className="absolute bottom-[0%] right-[0%] w-[50%] h-[50%] bg-[#FF6B00]/10 blur-[120px] rounded-full" />
        </div>
        
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          <p className="text-[#007AFF] text-[11px] sm:text-xs font-medium tracking-[0.12em] uppercase mb-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {config.name} CAMPUS SUMMER SCHOOL
          </p>
          <h1 className="text-4xl md:text-6xl font-semibold tracking-tight text-white mb-6 whitespace-pre-line leading-tight animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
          ...
          <Link 
            href={reservationUrl}
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-[#007AFF] text-white font-semibold text-[15px] hover:scale-105 active:scale-95 transition-all shadow-lg shadow-[#007AFF]/20 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300"
          >
          ...
          <div className="grid gap-8 md:grid-cols-3 fade-in-up">
            {summerContent.mindsetRules.items.map((rule, idx) => (
              <div key={idx} className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl hover:bg-white/[0.05] transition-colors duration-300 relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-6 opacity-10 font-semibold text-6xl text-white transform group-hover:scale-110 transition-transform duration-500 pointer-events-none">
                  0{idx + 1}
                </div>
                <h4 className="text-[#007AFF] font-semibold text-sm mb-2">{rule.subtitle}</h4>
                <h3 className="text-2xl font-semibold text-white mb-4 tracking-tight">{rule.title}</h3>
      ...
      <section className="bg-white pb-20 md:pb-28 pt-12 md:pt-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="mb-12 text-center fade-in-up">
            <p className="text-[13px] text-[#86868B] font-medium mb-4">Overview</p>
            <h2 className="text-3xl md:text-4xl font-semibold text-[#1D1D1F] tracking-tight mb-4">모집 개요</h2>
          </div>
          
          <div className="bg-[#F5F5F7] rounded-3xl p-8 md:p-10 shadow-sm fade-in-up">
            <ul className="space-y-6">
              <li className="flex gap-4">
                <Users className="text-[#007AFF] flex-shrink-0" size={24} />
                <div>
                  <h4 className="text-sm font-semibold text-[#86868B] mb-1">대상</h4>
                  <p className="text-[#1D1D1F] font-medium leading-relaxed">{summerContent.overview.target}</p>
                </div>
              </li>
              <li className="flex gap-4">
                <Calendar className="text-[#007AFF] flex-shrink-0" size={24} />
                <div>
                  <h4 className="text-sm font-semibold text-[#86868B] mb-1">기간</h4>
      ...
      <section className="bg-[#F5F5F7] py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6">
          <div className="mb-12 text-center fade-in-up">
            <h2 className="text-3xl md:text-4xl font-semibold text-[#1D1D1F] tracking-tight mb-4">이런 학생에게 추천합니다</h2>
          </div>
      ...
      <section className="bg-white py-20 md:py-28" style={{ backgroundColor: '#EEF2FF' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="mb-12 text-center fade-in-up">
            <h2 className="text-3xl md:text-5xl font-semibold text-[#1D1D1F] tracking-tight mb-4 leading-tight">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {summerContent.features.items.map((f, i) => {
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 rounded-full bg-[#007AFF]/10 flex items-center justify-center flex-shrink-0 text-[#007AFF]">
      ...
      <section className="bg-white py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-6">
          <div className="mb-16 text-center fade-in-up">
            <p className="text-[13px] text-[#86868B] font-medium mb-4">Process</p>
            <h2 className="text-3xl md:text-4xl font-semibold text-[#1D1D1F] tracking-tight mb-4">등록 절차 및 안내</h2>
          </div>
            ...
            {summerContent.registrationSteps.map((step, i) => (
              <div key={i} className="flex-1 relative">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  <div className="w-12 h-12 rounded-full bg-[#007AFF] text-white flex items-center justify-center font-semibold mb-4 shadow-md">
                    {i + 1}
                  </div>
                  <h4 className="text-lg font-semibold text-[#1D1D1F] mb-2">{step.title}</h4>
          ...
          <div className="bg-[#1D1D1F] text-white rounded-3xl p-8 md:p-12 fade-in-up">
            <h3 className="text-2xl font-semibold mb-8">안내 사항</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-[#007AFF] font-semibold mb-2">포함 내역</h4>
              ...
              <div className="md:col-span-2 pt-6 border-t border-white/10">
                <h4 className="text-white font-semibold mb-2">수강료</h4>
            ...
            <div className="mt-8 text-center">
              <Link 
                href={reservationUrl}
                className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-white text-[#1D1D1F] font-semibold hover:bg-gray-100 transition-colors"
              >
                썸머스쿨 예약 (구글폼)
              </Link>
            </div>
          ...
          <div className="fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2.5 rounded-full border border-black/10 bg-[#00C73C]/10 text-[#00C73C] font-semibold hover:bg-[#00C73C]/20 transition-all duration-300 px-8 py-4 w-full sm:w-auto"
              >
                네이버 톡톡 문의하기
              </a>
            </div>
