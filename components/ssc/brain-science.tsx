...
export default function BrainScience() {
  return (
    <section className="relative py-32 md:py-48 bg-[#0A0A0B] text-white overflow-hidden">
      ...
      <div className="absolute bottom-[10%] -right-20 w-[600px] h-[600px] bg-blue-600/10 blur-[150px] rounded-full pointer-events-none opacity-60" />

      <div className="max-w-[72rem] mx-auto px-6 sm:px-8 relative z-10 text-center">
        <BlurFade delay={0.1}>
          <p className="text-[#007AFF] text-[11px] font-semibold tracking-[0.18em] uppercase mb-6 drop-shadow-[0_0_15px_rgba(0,113,227,0.3)]">
            The Science of Focus
          </p>
        </BlurFade>
        
        <BlurFade delay={0.2}>
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-semibold text-white mb-10 leading-[1.05] tracking-tight text-balance">
            의지는 배신하지만,<br />
