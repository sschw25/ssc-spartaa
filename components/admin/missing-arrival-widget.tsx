    ...
    <div className="admin-fit-box rounded-3xl glass border-amber-500/20 p-5">
      <div className="flex items-start justify-between gap-3">
        <div className="flex min-w-0 items-center gap-2 text-left">
          ...
          <h3 className="flex min-w-0 flex-wrap items-baseline gap-x-1 text-[15px] font-semibold tracking-tight text-slate-900 dark:text-slate-100">
            <span>미등원 알림</span>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full text-slate-500 transition-colors hover:bg-black/[0.04] dark:hover:bg-white/10 hover:text-[#0071E3]"
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {filtered.map((r) => (
                <button
                  ...
                  className="flex min-h-9 items-center gap-1.5 rounded-full border border-amber-200 bg-white dark:bg-[#1c1c1e] px-3 py-1.5 text-[12px] font-semibold text-amber-700 transition-colors hover:border-amber-400 hover:bg-amber-50 dark:hover:bg-amber-500/10"
                >
                  {r.name}
